...
## Contexto do Projeto
- **Nome do App:** CorrecaoSistema
- **Objetivo:** Criar um utilitário em Python para analisar e restaura o windows;.
...
- **Compilação do Executável (com UAC Admin e ícone):** `Dism /Cleanup-Mountpoints`, `Dism /Online /Cleanup-Image /ScanHealth`, `Dism /Online /Cleanup-Image /RestoreHealth`, `SFC / SCANNOW`: Cada processo precisa ser finalizado para começar o outro. 
