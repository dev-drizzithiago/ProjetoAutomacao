...
class LeituraPdf:
    ...
    def extrair_campos_com_regex(self):
        ...
        busca_debito_exigibilidade_suspensa = valor_debito_exigibilidade_suspensa.search(
            total_debito_exigibilidade_suspensa)
        ...
        busca_compile_28_tot_debit_exigi_suspensa = compile_28_tot_debit_exigi_suspensa.search(
            busca_texto_compile_28).group()
        ...
        busca_valores_tot_debit_exigi_suspensa = valor_tot_debit_exigi_suspensa.search(
            busca_compile_28_tot_debit_exigi_suspensa)
